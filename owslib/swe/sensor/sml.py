...
class PropertyGroup(object):
    ...
    def get_characteristics_by_name(self, name):
        ...
        """
        return [self.characteristics[charac] for charac in list(self.characteristics.keys()) if charac.lower() == name.lower()]
...
class GeneralInfoGroup(object):
    ...
    def get_identifiers_by_name(self, name):
        ...
        """
        return [self.identifiers[identifier] for identifier in list(self.identifiers.keys()) if identifier.lower() == name.lower()]
