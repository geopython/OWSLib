...
#owslib imports:
from owslib.owscommon import ServiceIdentification, ServiceProvider, OperationMetadata
...
class WebFeatureService_2_0_0(object):
    ...
    def _buildMetadata(self):
        ...
        self.identification=ServiceIdentification(serviceidentelem, self.version)  
