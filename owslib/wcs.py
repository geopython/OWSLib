...
def WebCoverageService(
    url, version=None, xml=None, cookies=None, timeout=30, auth=None, headers=None
):
    ...
    if version is None:
        if xml is None:
            ...
            xml = openURL(
                request, cookies=cookies, timeout=timeout, auth=auth, headers=headers
            ).read()
    ...
    if version == "1.0.0":
        return wcs100.WebCoverageService_1_0_0.__new__(
            wcs100.WebCoverageService_1_0_0,
            clean_url,
            xml,
            cookies,
            auth=auth,
        ...
        return wcs110.WebCoverageService_1_1_0.__new__(
            wcs110.WebCoverageService_1_1_0,
            url,
            xml,
            cookies,
            auth=auth,
        ...
        return wcs111.WebCoverageService_1_1_1.__new__(
            wcs111.WebCoverageService_1_1_1,
            url,
            xml,
            cookies,
            auth=auth,
        ...
        return wcs200.WebCoverageService_2_0_0.__new__(
            wcs200.WebCoverageService_2_0_0,
            url,
            xml,
            cookies,
            auth=auth,
